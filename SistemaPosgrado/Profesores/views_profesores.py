...
def BajaProfesores (request):
    ...
    if(request.method == "POST"):
        ...
        profesor=Personal.objects.get(Num_Emp=numero_empleado,Nombre_P=nombre,Apellido_PP=apellidoP,Apellido_MP=apellidoM,Cargo='Profesor').update(Cargo="Inactivo")
        profesor.save()
