...
urlpatterns = [
    ...
    path('Calificacion_Alumno/',login_required(views_alumno.Calificacion_alumnos)),
    path('Calificacion_Profesores/',login_required(views_alumno.Calificacion_profesores)),
